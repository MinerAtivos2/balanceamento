    ...
    if (textElement) {
      if (data.is_outdated) {
        textElement.innerHTML = `
          <div class="outdated-disclaimer">[AVISO: Estas notícias não necessariamente retratam o desempenho do dia, pois não houve fontes disponíveis para a data atual.]</div>
